<form method="post" id="data_form">
    <div class="row ">
        <div class="col-md-6 card p-mobile">
            ...
            <?php   if(!empty($pet_detail))
                {
                ?>
                <input type="text" value="<?=$pet_detail['user_name']?>" class="form-control round mousetrap" name="cst" id="pos-customer-box" placeholder="<?php echo $this->lang->line('Enter Customer Name'); ?> " autocomplete="off" />
            <?php } ?>
            </div>
