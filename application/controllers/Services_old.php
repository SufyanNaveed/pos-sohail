...
class Services extends CI_Controller
{
    ...
    public function service_list()
    {
        ...
        foreach ($list as $prd) {
            ...
            $row[] = $no;
            $pid = $prd->pid;
            $row[] = '<a href="#" data-object-id="' . $pid . '" class="view-object"><span class="avatar-lg align-baseline"><img src="' . base_url() . 'userfiles/service/thumbnail/' . $prd->image . '" ></span>&nbsp;' . $prd->service_name . '</a>';
